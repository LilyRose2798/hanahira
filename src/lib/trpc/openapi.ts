...
export const getOpenApiDocument = cache(async (): Promise<OpenAPIObject> => {
  const doc: OpenAPIObject = generateOpenApiDocument(appRouter, {
    title: "Hanahira API",
